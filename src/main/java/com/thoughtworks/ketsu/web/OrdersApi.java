...
import com.thoughtworks.ketsu.web.beans.OrderBaseResponseBean;
...
public class OrdersApi {
    ...
    public List<OrderBaseResponseBean> getAllOfUser(@Context OrderRepository orderRepository) {
        return orderRepository.findAllOfUser(user.getId())
                .stream()
                .map(OrderBaseResponseBean::new)
